...
public class KnifeText extends EditText implements TextWatcher {
    ...
    protected int bulletColor = 0;
    protected int bulletRadius = 0;
    protected int bulletGapWidth = 0;
    protected boolean historyEnable = true;
    protected int historySize = 100;
    protected int linkColor = 0;
    protected boolean linkUnderline = true;
    protected int quoteColor = 0;
    protected int quoteStripeWidth = 0;
    protected int quoteGapWidth = 0;

    protected List<Editable> historyList = new LinkedList<>();
    protected boolean historyWorking = false;
    protected int historyCursor = 0;

    protected SpannableStringBuilder inputBefore;
    protected Editable inputLast;
