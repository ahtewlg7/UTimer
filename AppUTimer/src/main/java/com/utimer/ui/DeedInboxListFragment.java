...
public class DeedInboxListFragment extends ABaseDeedListFragment implements BaseDeedListMvpP.IBaseDeedMvpV {
    ...
    public void onViewCreated(View inflateView) {
        ...
        workState = new DeedState[]{INBOX, MAYBE};
    }
    ...
    protected String getTitle() {
        return MyRInfo.getStringByID(R.string.title_deed_list_new);
    }
