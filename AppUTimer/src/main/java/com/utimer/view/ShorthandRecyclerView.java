...
public class ShorthandRecyclerView extends ABaseLinearRecyclerView<ShortHandEntity> {
    ...
    @NonNull
    @Override
    public BaseItemAdapter<ShortHandEntity> createAdapter(Context context, List<ShortHandEntity> entityList) {
        return new ShorthandItemAdapter(context, entityList);
    }
