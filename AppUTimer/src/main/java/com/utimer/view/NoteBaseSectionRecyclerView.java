...
public class NoteBaseSectionRecyclerView extends ABaseSectionRecyclerView{
    public static final String TAG = NoteBaseSectionRecyclerView.class.getSimpleName();
    ...
    public NoteBaseSectionRecyclerView(Context context) {
        super(context);
    }

    public NoteBaseSectionRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NoteBaseSectionRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public class GtdBaseSectionAdapter extends BaseSectionAdapter<BaseSectionEntity>{
        ...
        protected void convert(BaseViewHolder helper, BaseSectionEntity item) {
            NoteEntity noteEntity = (NoteEntity)item.t;
            helper.setImageResource(R.id.view_gtd_iv, R.mipmap.ic_launcher);
            helper.setText(R.id.view_gtd_tv, noteEntity.getNoteName());
        }
    }
}
